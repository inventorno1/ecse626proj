...
out_dir = "/cim/ehoney/ecse626proj/experiment3"
...
model = UNet2DConditionModel(
    sample_size=128,
    in_channels=16, #16
    out_channels=16, #8 #initialise to maximum and compute loss only for indexed slices
...
for epoch in range(epoch_start, epochs):
    ...
    for step, batch in enumerate(train_dataloader):
        ...
        loss = loss_fn(predicted_noise[:, :8], noise)
