...
out_dir = "/cim/ehoney/ecse626proj/experiments/experiment15"
...
train_dataset = ADNIDatasetSlicesInOrder(data_dir, n=slices_at_once, return_target_slice_index=True, symmetric_normalisation=False, data_size=data_size, sample_range='middle')
